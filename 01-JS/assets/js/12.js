...
l(Prenoms);
l("*****************************************************");
// Connaitre le nombre d'éléments de mon tableau
var nombreDElementsDeMonTableau = Prenoms.length;
l(nombreDElementsDeMonTableau);
l("*****************************************************");
// Pour afficher un élément dans un tableau indexé, j'utilise son index
l(Prenoms[2]); // Rachma
l(Prenoms[0]); // Salim
l(Prenoms[4]); // Cheffia
var i = 3
l(Prenoms[i]); // Freddy
l("*****************************************************");
// Pour i = 0 au départ; tant que i est strictement < à 
// "nombreDElementsDeMonTableau" (Prenoms.length); alors
// i++ (incrémentation pas de 1)
for (let i = 0 ; i < nombreDElementsDeMonTableau ; i++){
...
l(Contacts);
l("Prenom = " + Contacts.prenom);
l("Nom = " + Contacts.nom);
l("Téléphone = " + Contacts.tel);
l("*****************************************************");
...
// -- Ce n'est vraiment pas pratique pour manipuler les données... 
// On va plutôt privilégier les Objets.
...
// -- Comment accéder aux valeurs de mon objet, dans un tableau indexé !
    ...
    // située à l'index 3 de mon tableau "Contacts"
