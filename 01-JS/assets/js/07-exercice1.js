    ...
    let prenom = prompt("Quel est votre prénom", "Ici svp");
    function sayname() {
        alert("Votre prénom est " + prenom);
    }
    sayname();
    let age = parseInt(prompt("Quel est votre age " + prenom, "Ici svp"));
    dob = new Date();
    now = dob.getFullYear();
    yob = now - age
    // document.write(age + " <br>")
    // document.write(now + " <br>")
    // document.write(yob + " <br>")
    function sayage() {
        alert(prenom + " votre date de naissance est " + yob );
    }
    sayage();
